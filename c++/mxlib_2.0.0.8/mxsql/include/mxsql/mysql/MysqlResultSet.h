...
#ifndef __MXSQL_MYSQL_MYSQLRESULTSET_H__
#define __MXSQL_MYSQL_MYSQLRESULTSET_H__
...
{
private:
	MysqlResultSet(const MysqlResultSet&);
	MysqlResultSet& operator =(const MysqlResultSet&);
public:
	MysqlResultSet(MYSQL_RES* result, SqlResultSet::enum_type resultType);
...
#endif /* __MXSQL_MYSQL_MYSQLRESULTSET_H__ */
